...
<table bordercolor="#66b2b2">
  ...
  <a href="https://hust.edu.ng/" target="_blank">
    <img src="https://img.shields.io/static/v1?label=|&message=VIDEO&color=cdf998&style=plastic&logo=wordpress&logo-color=white"/>
        ...
        <p><strong>Javascript, Tailwind, Node.js, & Express.js</strong> - Official Platform of Hillside University of Science and Technology, manages content with a content management admin panel, regulates and links admission process for students  </p>
    </td>
    <td width="50%" valign="top">
